...
| 2026-09-25 現況 | 做完 18、做了一部分 4、缺的那塊是刻意不做 3、沒做 12（含同一天 #640 做掉的右側欄；2026-09-26 #645 做掉 29 送出佇列，成為做完 19、沒做 11）；盤點時寫「沒有一件是 web 自己就能做的」錯了一項：右側欄的內容早就有了，只是放在 Sheet。其餘沒做的都要 harness 先投影、先開一條路，或是整塊新功能 | §2.0.1 |
...
| 沒做（11） | 8 會話標頭、16 子代理檢視、17 逐輪用量、18 壓縮列、20 附件、24 計劃審核、25 權限模式、28 `@` 引用、30 模型選擇、33 目標列、37 輪次側軌 |
