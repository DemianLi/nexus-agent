...
| core 的能力拆成可關的條目＋設定機制 | **啟動 [#46](https://github.com/DemianLi/nexus-agent/issues/46)**（2026-09-19 拍板），第一步把摘要與修剪拆成兩顆（[#446](https://github.com/DemianLi/nexus-agent/issues/446)） | [`decisions-2026-09-19.md`](decisions-2026-09-19.md) 第 12 題；[`srp-audit-2026-09-19.md`](srp-audit-2026-09-19.md) |
