 ...
 *
 * @returns 掛著它的條目，註冊 `@nexus/plugin-quickjs` 配套入口的 plugin。
 */
export function createQuickJsInvariantPlugin(): PluginEntry {
  return { plugin: quickJsInvariantPlugin };
}
 ...
 */
export const quickJsInvariantPlugin: NexusPlugin = {
