 ...
 *
 * @returns 掛著它的條目，註冊 `@nexus/plugin-memory` 配套入口的 plugin。
 */
export function createMemoryInvariantPlugin(): PluginEntry {
  return { plugin: memoryInvariantPlugin };
}
 ...
 */
export const memoryInvariantPlugin: NexusPlugin = {
