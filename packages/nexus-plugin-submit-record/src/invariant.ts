 ...
 *
 * @returns 掛著它的條目，註冊 `@nexus/plugin-submit-record` 配套入口的 plugin。
 */
export function createSubmitRecordInvariantPlugin(): PluginEntry {
  return { plugin: submitRecordInvariantPlugin };
}
 ...
 */
export const submitRecordInvariantPlugin: NexusPlugin = {
