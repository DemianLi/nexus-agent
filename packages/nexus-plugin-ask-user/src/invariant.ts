 ...
 *
 * @returns 掛著它的條目，註冊 `@nexus/plugin-ask-user` 配套入口的 plugin。
 */
export function createAskUserInvariantPlugin(): PluginEntry {
  return { plugin: askUserInvariantPlugin };
}
 ...
 */
export const askUserInvariantPlugin: NexusPlugin = {
