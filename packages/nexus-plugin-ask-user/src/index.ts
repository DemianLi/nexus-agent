...
/**
 * 建一個條目。**薄薄一層**：這個 plugin 沒有任何資料設定，協作者走服務注入
 * （[#459](https://github.com/DemianLi/nexus-agent/issues/459)），所以它真的只是包一層。
 *
 * @returns 可以放進組裝點清單的條目。
 */
export function createAskUserPlugin(): PluginEntry {
  return { plugin: askUserPlugin };
}
