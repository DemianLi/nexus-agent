 ...
 *
 * @returns 掛著它的條目，註冊 `@nexus/plugin-skills` 配套入口的 plugin。
 */
export function createSkillsInvariantPlugin(): PluginEntry {
  return { plugin: skillsInvariantPlugin };
}
 ...
 */
export const skillsInvariantPlugin: NexusPlugin = {
