/* global console */
/**
 * #377 設計 token 定稿的產生器（設計期工具，不進產品）。
 *
 ...
 *
 * 輸出：tokens.generated.css（oklch）＋ token-table.md（值與對比度表）。
 */
...
writeFileSync(
  ...
  `/* 由 #377 產生器輸出（Leonardo 底色 lightness：亮 ${L.light}、暗 ${L.dark}），不要手改。 */\n\n` +
    css(':root[data-proto-375]', tokens.light) +
    '\n' +
    css(':root[data-proto-375].dark', tokens.dark),
);
...
writeFileSync('token-table.md', md);
console.log(md);
