/**
 * 來源：shadcn registry `button`（style new-york，https://ui.shadcn.com/r/styles/new-york-v4/button.json），
  ...
  "inline-flex shrink-0 items-center justify-center gap-2 rounded-full text-sm font-medium whitespace-nowrap transition-all outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-60 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        outline: 'bg-card shadow-material hover:bg-chip-hover active:bg-chip-pressed',
        secondary:
          'bg-secondary text-secondary-foreground hover:bg-chip-hover active:bg-chip-pressed',
        ghost: 'hover:bg-chip-hover active:bg-chip-pressed',
